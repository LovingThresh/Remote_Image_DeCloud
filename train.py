...
train_data_txt = 'O:/Dataset/cloud detection and removal dataset/paper/cloud detection/Train/cloud.txt'
val_data_txt = 'O:/Dataset/cloud detection and removal dataset/paper/cloud detection/Val/cloud.txt'
test_data_txt = 'O:/Dataset/cloud detection and removal dataset/paper/cloud detection/Test/cloud.txt'

raw_train_dir = 'O:/Dataset/cloud detection and removal dataset/paper/cloud detection/Train/temporal'
mask_train_dir = 'O:/Dataset/cloud detection and removal dataset/paper/cloud detection/Train/masked'

raw_val_dir = 'O:/Dataset/cloud detection and removal dataset/paper/cloud detection/Val/temporal'
mask_val_dir = 'O:/Dataset/cloud detection and removal dataset/paper/cloud detection/Val/masked'

raw_test_dir = 'O:/Dataset/cloud detection and removal dataset/paper/cloud detection/Test/temporal'
mask_test_dir = 'O:/Dataset/cloud detection and removal dataset/paper/cloud detection/Test/masked/show'


def get_Cloud_Image_Dataset(re_size, batch_size):
    train_dataset = data_loader.Cloud_Blur_Dataset(raw_image_path=raw_train_dir,
                                                    cloudy_image_path=mask_train_dir,
                                                    re_size=re_size,
                                                    data_txt=train_data_txt)

    val_dataset = data_loader.Cloud_Blur_Dataset(raw_image_path=raw_val_dir,
                                                  cloudy_image_path=mask_val_dir,
                                                  re_size=re_size,
                                                  data_txt=val_data_txt)

    test_dataset = data_loader.Cloud_Blur_Dataset(raw_image_path=raw_test_dir,
                                                   cloudy_image_path=mask_test_dir,
                                                   re_size=re_size,
