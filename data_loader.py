...
class Cloud_Blur_Dataset(Dataset):

    def __init__(self, raw_image_path, cloudy_image_path, re_size, data_txt, transformer=transform):
        self.raw_image_path = raw_image_path
        self.cloudy_image_path = cloudy_image_path
        self.re_size = re_size
        self.data_txt = data_txt
        self.transform = transformer
        with open(self.data_txt, 'r') as f:
    ...
    def __getitem__(self, item):
        ...
        self.blur_image = cv2.imread(os.path.join(self.cloudy_image_path, self.file_list[item].split(',')[1]))
        ...
        return self.blur_image, self.raw_image, self.raw_image
